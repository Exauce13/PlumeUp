          ...
          <div class="p-6">
            <div class="flex items-center justify-between">
              ...
              <div class="flex-1 flex items-center space-x-4">
                ...
                <div class="flex-shrink-0">
                  <div class="w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center shadow-lg">
                    <span class="text-white font-bold text-lg">{{ $chapitre->numerochapitre }}</span>
                  </div>
                </div>
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div class="flex items-center space-x-4 text-sm text-gray-500">
                    <span class="flex items-center">
                      ...
                      Chapitre {{ $chapitre->numerochapitre }}
                    </span>
                    <span class="flex items-center">
              ...
              <div class="flex-shrink-0 ml-6">
                <a href="{{ asset('storage/' . $chapitre->url_chapitre) }}" target="_blank" class="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-200 flex items-center space-x-2 shadow-lg hover:shadow-xl">
