...
<html>
        ...
        <div class="flex flex-col items-center space-y-0">
            @forelse($images as $image)
                <div class="w-full mb-0">
                    <img src="{{ asset('storage/'. $image) }}" alt="Image" class="w-full h-auto object-cover rounded shadow">
                </div>
            @empty
    ...
    <div class="mt-8 flex justify-center">
        <a href="{{ route('imgchap', $img->histoire->id) }}" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded text-sm text-center shadow transition">
